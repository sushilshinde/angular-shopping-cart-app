...
describe('ProductDetailsComponent', () => {
  ...
  it('should fetch product data on ngOnInit', () => {
    fixture.detectChanges();
    component.ngOnInit();
    expect(mockShopService.getProductById).toHaveBeenCalledWith(1);
    expect(component.productData).toEqual(mockProductData);
  });

 

  // ... add more tests for handleCount, authentication check, and cart item check
});
