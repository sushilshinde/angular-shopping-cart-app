...
export const loadCart = createAction(CartActions.LOAD_CART, props<{ id }>())
...
export const removeItemSuccess = createAction(CartActions.REMOVE_ITEM_SUCCESS, props<{ id }>())
export const addItem = createAction(CartActions.ADD_ITEM, props<{ id }>())
...
export const removeQuantity = createAction(CartActions.REMOVE_QUANTITY, props<{ id: number }>())
